...
typedef NS_ENUM(NSInteger,IGTabSliderViewStyle){
    
    IGTabSliderViewStyleEqualWidth,
    IGTabSliderViewStyleNotEqualWidth
};


@interface IGTabSliderView : UIView
 ...
 *
 */
@property (nonatomic,assign) IGTabSliderViewStyle style;
...
// 顶部标题高亮色
@property (nonatomic,strong) UIColor *topTitleHighlightedColor;

// 顶部标题栏的高度
@property (nonatomic,assign) CGFloat topTitleViewHeight;
